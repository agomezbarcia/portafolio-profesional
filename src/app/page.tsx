              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
                ...
                <div className="space-y-8">
                  ...
                  <div className="space-y-4">
                    <a href={`mailto:${PORTFOLIO_DATA.email}`} className="flex items-center gap-4 p-4 rounded-xl bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-800 hover:border-blue-500 dark:hover:border-blue-500 transition-all group">
                      ...
                      <div>
                        ...
                        <p className="text-slate-900 dark:text-white font-medium">{PORTFOLIO_DATA.email}</p>
                      </div>
                    </a>

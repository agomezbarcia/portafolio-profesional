  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main>
        ...
        <section id="contacto" className="py-20 px-4 bg-gradient-to-b from-slate-50 to-white">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 py-8">
              ...
              >
                ...
                <p className="text-slate-600 mb-4">Conecta conmigo</p>
                <span className="inline-block text-blue-600 font-semibold group-hover:translate-x-1 transition-transform">
                  Visitar →
                </span>
              </a>
              ...
              >
                ...
                <p className="text-slate-600 mb-4">Mira mis proyectos</p>
                <span className="inline-block text-blue-600 font-semibold group-hover:translate-x-1 transition-transform">
                  Visitar →
                </span>
              </a>
